...
public class MoveViewLeftListener extends MapCreationKeyListener {

	public MoveViewLeftListener(CanvasTileManager tileManager) {
		super(tileManager, Constants.LEFT_ARROW_KEY);
	}
